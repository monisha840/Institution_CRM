  ...
  return (
    <div className="af-shell">
            ...
            <form onSubmit={submit} className="af-form">
              ...
              <div className="af-section">
                ...
                <Field label="Mobile number (10 digits) *">
                  <div className="af-phone" style={phoneError ? { borderColor: "var(--err)" } : undefined}>
                    ...
                    <input
                      ...
                      required
                    />
                    <span className="af-phone-count" style={{ color: phoneOk ? "var(--ok)" : "var(--ink-4)" }}>
                      {form.phoneDigits.length}/10
                    </span>
                  </div>
      ...
      <style jsx>{`
        ...
        .af-input:focus { outline: none; border-color: var(--brand); }
        ...
        .af-field-err { font-size: 11px; color: var(--err); font-weight: 700; }
        .af-err {
        ...
        .af-done h2 { font-size: 22px; font-weight: 800; color: var(--ink); margin: 0 0 12px; }
        .af-done p { font-size: 13px; line-height: 1.6; color: var(--ink-3); font-weight: 600; margin: 0 0 12px; }
        .af-contact { padding: 12px 14px; background: var(--bg); border-radius: 8px; }
        .af-foot {
