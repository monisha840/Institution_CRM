  ...
  return (
    <div className="df-shell">
      ...
      <style jsx>{`
        ...
        .df-title { margin: 22px 0 4px; font-size: 24px; font-weight: 800; color: var(--ink); letter-spacing: -0.02em; }
        .df-sub { margin: 0 0 22px; font-size: 13px; line-height: 1.6; color: var(--ink-3); font-weight: 600; }
        ...
        .df-input:focus { outline: none; border-color: var(--brand); background: var(--card); }
        ...
        .df-done h2 { font-size: 22px; font-weight: 800; color: var(--ink); margin: 0 0 12px; }
        .df-done p { font-size: 13px; line-height: 1.6; color: var(--ink-3); font-weight: 600; margin: 0 0 12px; }
        .df-contact { padding: 12px 14px; background: var(--bg); border-radius: 8px; }
        .df-foot {
